...
public class MarsAtmosphereRenderer {
    ...
    private static final String FRAG_SRC =
            "#version 150 core\n" +
                    ...
                    "    vec3 innerColor = vec3(0.95, 0.60, 0.20);\n" +
                    "    vec3 outerColor = vec3(0.85, 0.30, 0.10);\n" +
                    "    vec3 backColor = vec3(0.40, 0.15, 0.05);\n" +
    ...
    private static void initIfNeeded() {
        ...
        if (GL20.glGetProgrami(shaderProgram, GL20.GL_LINK_STATUS) == GL11.GL_FALSE) {
            throw new RuntimeException("[MarsAtmosphere] Link error: " + GL20.glGetProgramInfoLog(shaderProgram));
        }
    ...
    private static int compileShader(int type, String src) {
        ...
        if (GL20.glGetShaderi(id, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
            throw new RuntimeException("[MarsAtmosphere] Compile error:\n" + GL20.glGetShaderInfoLog(id));
        }
        return id;
    }
